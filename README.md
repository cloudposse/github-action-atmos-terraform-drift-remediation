...
> [!WARNING]
> **Deprecated.** Migrate to [Atmos Native CI](https://atmos.tools/deprecated/github-actions/atmos-terraform-drift-remediation).

This action is deprecated in favor of Atmos Native CI. See the migration guide at
https://atmos.tools/deprecated/github-actions/atmos-terraform-drift-remediation for the equivalent
built-in command (`atmos terraform deploy`, triggered from an issue) and how to move your workflow over.
